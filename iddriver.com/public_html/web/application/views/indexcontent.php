...
<div style="margin-top:-72px">
  <div class="row" style="padding:0;margin:0;">
    <div id='cssmenu'>
      <ul>
        <li><a href='<?php echo site_url('main/consultants')?>'><span>ที่ปรึกษา</span></a></li>
        ...
        <li>
          <div class="dropdown">
            ...
            foreach($branch as $key=>$value){?>
              ...
              <a href="<?php echo site_url('main/branch_3')?>">สาขา มหาสารคาม</a> -->
            </div>
          </div>
        </li>

         <!-- <li><a class='last' href='<?php echo site_url('main/branch_kk')?>'><span>สาขา ในเมืองขอนแก่น</span></a></li> -->
            ...
            <aside>
              <div class="widget" id="index-left-menu">
                ...
                <div class="row" style="position:relative;top:-40px;">
                  <div class="col-lg-12 col-md-12 col-xs-12" > <a href="<?php echo site_url('main/register/3');?>"> <img src="<?php echo base_url()?>img/network/truck.jpg"  width="95%" class=""> </a></div>
                </div>
                <div class="row" style="position:relative; top:-60px;">
                  <div class="col-lg-12 col-md-12 col-xs-12" > <a href="<?php echo site_url('main/register/4');?>"> <img src="<?php echo base_url()?>img/network/trailer.jpg" width="95%" class=""> </a></div>
                </div>
