            ...
            <div class="col-lg-8" style="min-width:400px">
				...
				for($i=0;$i<count($content);$i++){
					...
					if(empty($id)){
						...
						echo '<a href="'.site_url("main/news").'/'.$content[$i]['ID'].'" class="pull-right">อ่านต่อ <i class="icon-angle-right"></i></a>';
						echo '</p>';
					}else{
						echo '<br><p>';
						echo html_entity_decode($content[$i]['description']);
						echo '<br><a href="'.site_url("main/news").'" class="pull-right">ย้อนกลับ <i class="icon-angle-right"></i></a>';
						echo '<br></p>';
					}
					echo '<hr>';
				}
